...
export const metadata: Metadata = {
  title: 'Complete Guide: Cost of Having a Baby in Australia 🇦🇺 - 2025 Breakdown',
  description: 'Comprehensive guide to baby costs in Australia from pregnancy to age 5. Detailed breakdown of prenatal care, delivery expenses, and child-rearing costs with Medicare insights and state variations.',
  keywords: [
    'baby cost Australia',
    'pregnancy expenses Australia',
    'delivery cost Australia',
    'child expenses Australia',
    'maternity cost Australia',
    'prenatal care cost Australia',
    'hospital delivery cost Australia',
    'baby budget Australia',
    'child care costs Australia',
    'pregnancy budget planning Australia',
    'Medicare pregnancy',
    'maternity leave Australia'
  ],
  openGraph: {
    title: 'Complete Guide: Cost of Having a Baby in Australia 🇦🇺',
    description: 'Everything you need to know about baby costs in Australia - from pregnancy to school age with detailed breakdowns and Medicare planning tips.',
    type: 'article',
  },
};

export default function AustraliaGuidePage() {
  const countryData = getCountryBySlug('australia');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <header className="mb-12 text-center">
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-green-50/60 to-yellow-50/60 rounded-2xl p-6 lg:p-8 mb-8 border border-green-100/50">
            <div className="flex items-center justify-center gap-4 mb-4">
              <Calculator className="w-6 h-6 text-green-600" />
              <h3 className="text-lg font-semibold text-gray-800">Ready to Calculate Your Costs?</h3>
            </div>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              Use our interactive calculator to get personalized cost estimates based on your state, Medicare coverage, and preferences.
            </p>
            <Link href="/tools/cost-of-having-a-baby/australia">
              <button className="bg-gradient-to-r from-green-500 to-yellow-500 hover:from-green-600 hover:to-yellow-600 text-white px-8 py-3 rounded-lg font-medium flex items-center gap-2 mx-auto transition-all duration-200 shadow-lg hover:shadow-xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 mb-2">With Medicare</h4>
                <p className="text-sm text-gray-600">Public healthcare &amp; bulk billing</p>
              </div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Private hospitals &amp; specialists</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Medicare:</strong> Covers most pregnancy and delivery costs in public hospitals</li>
                <li>• <strong>Bulk Billing:</strong> Many GPs bulk bill, reducing out-of-pocket costs</li>
                <li>• <strong>Private Health Insurance:</strong> Optional but provides choice of doctor and hospital</li>
                <li>• <strong>Safety Net:</strong> Additional protection for high medical costs</li>
              </ul>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Child Care Subsidy:</strong> Government assistance for childcare costs</li>
                <li>• <strong>Long Day Care:</strong> $80-$150+ per day depending on location</li>
                <li>• <strong>Family Day Care:</strong> Often more affordable alternative</li>
                <li>• <strong>Kindergarten:</strong> Free in some states, subsidized in others</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="text-center p-4 bg-red-50 rounded-lg border border-red-100">
              ...
              <p className="text-sm text-red-700 mb-2">NSW, VIC, WA</p>
            ...
            <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-100">
              ...
              <p className="text-sm text-yellow-700 mb-2">QLD, SA, TAS</p>
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-100">
              ...
              <p className="text-sm text-green-700 mb-2">NT, ACT</p>
          ...
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Use our interactive calculator to customize costs based on your state, healthcare choices, and preferences for a personalized estimate.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/tools/cost-of-having-a-baby/australia">
                <button className="bg-gradient-to-r from-green-500 to-yellow-500 hover:from-green-600 hover:to-yellow-600 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl">
                  <Calculator className="h-5 w-5" />
                  Start Calculating
                </button>
              </Link>
