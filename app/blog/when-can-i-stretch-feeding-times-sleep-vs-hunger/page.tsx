              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg my-6">
                    <h3 className="font-semibold text-yellow-800 mb-3">🤱 Real Mom Confession</h3>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg my-6">
                    <h4 className="font-semibold text-green-800 mb-3">✅ Green Light Indicators:</h4>
                    <ul className="text-green-700 space-y-2">
                      <li>• Baby has regained birth weight (usually by 10-14 days)</li>
                      <li>• Consistent weight gain (4-8 oz per week)</li>
                      <li>• At least 6 wet diapers per day</li>
                      <li>• Regular bowel movements</li>
                      <li>• Alert and active during wake periods</li>
                      <li>• No medical concerns from pediatrician</li>
                    </ul>
                  </div>

                  <div className="bg-red-50 border-l-4 border-red-400 p-6 my-8">
                    <h4 className="font-semibold text-red-800 mb-3">⚠️ Keep Frequent Feeds If:</h4>
                    <ul className="text-red-700 space-y-1">
                      <li>• Baby hasn&apos;t regained birth weight</li>
                      <li>• Premature or low birth weight baby</li>
                      <li>• Breastfeeding and supply is still establishing</li>
                      <li>• Any feeding or weight gain concerns</li>
                      <li>• Medical conditions requiring frequent monitoring</li>
                    </ul>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
                    <div className="bg-orange-50 p-6 rounded-lg">
                      ...
                      <ul className="text-orange-700 text-sm space-y-1">
                        <li>• Stirring and becoming more alert</li>
                    ...
                    <div className="bg-red-50 p-6 rounded-lg">
                      ...
                      <ul className="text-red-700 text-sm space-y-1">
                        ...
                        <li>• Agitated body movements</li>
                        <li>• Harder to calm down</li>
                        <li>• May need calming before feeding</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <ul>
                    <li>• Need for comfort or closeness</li>
                    <li>• Dirty diaper</li>
                    <li>• Too hot or cold</li>
                    <li>• Overstimulation</li>
                    <li>• Normal newborn fussiness</li>
                  </ul>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg my-6">
                    <h4 className="font-semibold text-yellow-800 mb-3">💡 Pro Tip: The Gradual Approach</h4>
                    <p className="text-yellow-700">
                      Instead of jumping from 2-hour to 4-hour stretches, try: 2 hours → 2.5 hours → 3 hours → 3.5 hours → 4 hours. This gives everyone time to adjust gradually.
                    </p>
                  </div>
                  ...
                  <div className="bg-red-50 p-6 rounded-lg my-6">
                    <h4 className="font-semibold text-red-800 mb-3">⚠️ Slow Down If You Notice:</h4>
                    <ul className="text-red-700 space-y-2">
                      <li>• Decreased weight gain or weight loss</li>
                      <li>• Fewer wet diapers (less than 6 per day)</li>
                      <li>• Baby seems more fussy or unsettled</li>
                      <li>• Difficulty latching when finally feeding</li>
                      <li>• Signs of dehydration (sunken eyes, fontanelle)</li>
                      <li>• Your instinct says something&apos;s not right</li>
                    </ul>
                  </div>
