...
export const metadata: Metadata = {
  title: 'Complete Guide: Cost of Having a Baby in the United States 🇺🇸 - 2025 Breakdown',
  description: 'Comprehensive guide to baby costs in the USA from pregnancy to age 5. Detailed breakdown of prenatal care, delivery expenses, and child-rearing costs with insurance insights and state variations.',
  keywords: [
    'baby cost USA',
    'pregnancy expenses United States',
    'delivery cost America',
    'child expenses USA',
    'maternity cost United States',
    'prenatal care cost USA',
    'hospital delivery cost America',
    'baby budget USA',
    'child care costs United States',
    'pregnancy budget planning USA',
    'health insurance pregnancy',
    'maternity leave USA'
  ],
  openGraph: {
    title: 'Complete Guide: Cost of Having a Baby in the United States 🇺🇸',
    description: 'Everything you need to know about baby costs in the USA - from pregnancy to school age with detailed breakdowns and insurance planning tips.',
    type: 'article',
  },
};

export default function USGuidePage() {
  const countryData = getCountryBySlug('united-states');
        ...
        <header className="mb-12 text-center">
          ...
          <div className="bg-gradient-to-r from-blue-50/60 to-red-50/60 rounded-2xl p-6 lg:p-8 mb-8 border border-blue-100/50">
            ...
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              Use our interactive calculator to get personalized cost estimates based on your state, insurance coverage, and preferences.
            </p>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 mb-2">With Insurance</h4>
                <p className="text-sm text-gray-600">Good coverage &amp; in-network providers</p>
              </div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 mb-2">Without Insurance</h4>
                <p className="text-sm text-gray-600">Out-of-pocket or limited coverage</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Health Insurance:</strong> Essential for managing costs - check coverage for maternity care</li>
                <li>• <strong>Deductibles:</strong> Plan for annual deductibles which can be $1,000-$7,000+</li>
                <li>• <strong>Out-of-pocket maximums:</strong> Know your yearly limit for catastrophic protection</li>
                <li>• <strong>In-network providers:</strong> Stay in-network to avoid surprise bills</li>
              </ul>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 p-6">
              <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Daycare costs:</strong> $8,000-$20,000+ annually depending on location</li>
                <li>• <strong>Preschool:</strong> $4,000-$15,000 annually for quality programs</li>
                <li>• <strong>529 Plans:</strong> Start saving early for college education</li>
                <li>• <strong>Child Tax Credit:</strong> $2,000 per child annually (2025)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="text-center p-4 bg-red-50 rounded-lg border border-red-100">
              <h4 className="font-medium text-red-800 mb-2">High Cost States</h4>
              <p className="text-sm text-red-700 mb-2">CA, NY, MA, CT, HI</p>
              <div className="text-lg font-bold text-red-600">150-200% of average</div>
            </div>
            <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-100">
              <h4 className="font-medium text-yellow-800 mb-2">Medium Cost States</h4>
              <p className="text-sm text-yellow-700 mb-2">TX, FL, IL, PA, OH</p>
              <div className="text-lg font-bold text-yellow-600">100-130% of average</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-100">
              <h4 className="font-medium text-green-800 mb-2">Lower Cost States</h4>
              <p className="text-sm text-green-700 mb-2">MS, AR, AL, WV, KY</p>
              <div className="text-lg font-bold text-green-600">70-90% of average</div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Use our interactive calculator to customize costs based on your state, insurance, and preferences for a personalized estimate.
            </p>
